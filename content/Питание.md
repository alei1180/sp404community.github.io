...
6 штук размера AA (пальчиковые), обязательно одинаковых. [Подойдут](https://support.roland.com/hc/en-us/articles/4408070930459-SP-404MK2-What-kind-of-batteries-can-I-use) перезаряжаемые Ni-MH или обычные (AA, LR6 × 6). Roland не рекомендует использовать Li-Ion аккумуляторные батареи.
...
От любого, где есть Quick Charge 3.0 (+провод) Или же просто USB-C — USB-C (пауэрбанк должен его поддерживать)
